...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Heading -->           
            <header class="bg-white shadow W-full h-16">
            ...
            <!-- Page Content -->
            <main class="prose sm:prose-lg px-5 mx-auto">               
                ...
                <div class="mt-5">
                    {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">             --}}
                        ...
                        @if (!session()->has('info'))
                            ...
                            text-center text-4xl font-extrabold text-transparent sm:text-xl"> Escríbeme</h2>
                        ...
                        @else
                            <h3 class="text-white bg-green-400 text-center"> {{ session('info') }}</h3>
                        @endif
